...
gtexColumnNames <- c(
  ...
  '<span title="A score ranging from 0-8. Genes that score higher are generally expressed stably over time for an individual, but expression levels vary between individuals.">Trait no. studies</span>',
  ...
  '<span title="The percentile of the within-subject standard deviation rank product across studies among the 6,099 genes.">Within Subject Standard Deviation Percentile</span>',
  '<span title="The percentile of the total standard deviation rank product across studies among the 6,099 genes.">Total Standard Deviation Percentile</span>',
  '<span title="The percentile of the repeatability statistic rank product across studies among the 6,099 genes.">Repeatability Percentile</span>',
  '<span title="The percentile of the genetic variance statistic rank product across studies among the 6,099 genes.">Genetic Variance Percentile</span>',
  '<span title="The percentile of the average expression rank product across studies among the 6,099 genes.">Average Expression Percentile</span>',
